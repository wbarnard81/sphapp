                ...
                <div class="card-body">
                    ...
                    <div class="flex-row">
                        <div class="d-flex justify-content-around">
                            @if (Auth::check())
                                <div>
                                    <a href="/computers" class="btn btn-primary">SPH Computers</a>
                                </div>
                                <div>
                                    <a href="/birthdays" class="btn btn-success">SPH Birthdays</a>
                                </div>
                                <div>
                                    <a href="/pcreturns" class="btn btn-warning">PC Returns</a>
                                </div>
                                <div>
                                    <a href="/pcmove" class="btn btn-info">PC Moves</a>
                                </div>
                            @endif
                            @guest
                                <div>
                                ...
                                <div>
                                    <a href="/pcmove/create" class="btn btn-info">Log PC Movement</a>
                                </div>
                            @endguest
                        </div>
                    </div>
