...
<div class="container">
    ...
    <div class="form-group">
        {{Form::label('memory', 'Memory')}} {{Form::text('memory', '', ['class' => 'form-control', 'placeholder' => '...'])}}
    </div>
    <div class="form-group">
        {{Form::label('officetype', 'Office Package')}} {{Form::text('officetype', '', ['class' => 'form-control', 'placeholder'
        => '...'])}}
    </div>
    <div class="form-group">
